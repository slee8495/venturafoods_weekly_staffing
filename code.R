...
# Define the paths
old_dir <- "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 24/Weekly Staffing/2024/03.25.2024"
new_dir <- "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 24/Weekly Staffing/2024/04.08.2024"
...
# Read in data
weekly_hiring_ms_data <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 24/Weekly Staffing/2024/04.08.2024/Weekly Site Staffing Update 04-02-24.xlsx",
                                           sheet = "Hiring MS DATA")

weekly_hires_terms <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 24/Weekly Staffing/2024/04.08.2024/Weekly Site Staffing Update 04-02-24.xlsx",
                                        sheet = "Hires & Terms")
...
weekly_hiring_ms_data_cleaned %>% 
  ...
  writexl::write_xlsx("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 24/Weekly Staffing/2024/04.08.2024/ms recap.xlsx")
...
rbind(terms_preweek, terms_thisweek) %>% mutate(Terms = ifelse(is.na(Terms), 0, Terms)) -> terms
rbind(hires_preweek, hires_thisweek) %>% mutate(Hires = ifelse(is.na(Hires), 0, Hires)) -> hires

cbind(terms, hires) %>% 
  writexl::write_xlsx("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 24/Weekly Staffing/2024/04.08.2024/Turnover Recap.xlsx")
